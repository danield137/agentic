...
| New elements | Canonical compact SVG per shared standards; use existing project-local icons or native shapes; AI images via `image_gen.py --manifest` when wanted |
