...
Sound acquisition is a workflow concern, not part of the animation core. The
Copilot core package accepts only user-provided project-local audio. Existing
low-level project-relative/absolute `.m4a`, `.mp3`, and `.wav` inputs remain
compatible; see [`animations.md`](../../references/animations.md) §2.2.
