...
two-slide project under the gitignored `projects/_smoke_*` namespace. Keep it
as a manual smoke procedure; do not turn it into a test file or public example
deck.
