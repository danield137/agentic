...
Project icon namespaces are subdirectories of <project>/icons/. The Copilot
core package uses user-supplied, imported, or deliberately authored local SVGs.
This tool never reads templates/icons directly and never accepts a bare name.
