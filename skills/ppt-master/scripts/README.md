...
| Animation resources | User-provided project-local audio only | [core sound contract](../templates/sounds/README.md); [docs/pptx-animations.md](./docs/pptx-animations.md) |
