...
The Copilot core package omits bundled icon libraries. Follow the
[project-local icon contract](./icons/README.md).

## Sound Library

The Copilot core package omits bundled sounds. Follow the
[project-local sound contract](./sounds/README.md).
