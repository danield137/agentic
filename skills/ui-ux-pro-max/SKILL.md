---
name: ui-ux-pro-max
description: Search and apply UI/UX design intelligence for web, mobile, and desktop. Use when designing, building, reviewing, or fixing interfaces, pages, components, design systems, accessibility, interaction, responsive layout, typography, color, charts, motion, or stack-specific UI implementation.
license: MIT; see LICENSE
version: "2.5.1-copilot"
---
...
Retain the absolute base directory from the loaded skill context as `SKILL_DIR`.
The search script lives inside this skill's own directory, not the project
directory. Always invoke it by its full path; never assume a working directory:
